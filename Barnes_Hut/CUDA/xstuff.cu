...
char *theBGcolor = (char *)DEFAULT_BGCOLOR,
  *theFGcolor = (char *)DEFAULT_FGCOLOR,
  *theFont = (char *)DEFAULT_FONT,
  *theGeom_rsrc = NULL,
  *display_name = NULL,
  *theGeom_cline = NULL,
  *theGeom = NULL;
...
APP_PARAMS app_resources[] = {
  {(char *)"background", &theBGcolor},
  {(char *)"foreground", &theFGcolor},
  {(char *)"font", &theFont},
  {(char *)"geometry", &theGeom_rsrc}
};
...
{
  {(char *)"-display", &display_name},
  {(char *)"-d", &display_name},
  {(char *)"-geometry", &theGeom_cline},
  {(char *)"-g", &theGeom_cline},
};
