...
/**************************************************************************/
__global__ void mem_init_outside(struct memory_t *mem, size_t block_size, int nb_blocks){
  Bloc *ptr;
  int i;
  ...
  //ptr = (Bloc*)calloc(nb_blocks, block_size);
  ptr = (Bloc*)malloc(nb_blocks*block_size);
  assert(ptr != 0);
